                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>
                                        <center>ID_Kecamatan</center>
                                    </th>
                                    <th>
                                        <center>Nama_Kecamatan</center>
                                    </th>
                                    <th>
                                        <center>Luas_Kecamatan (Ha)</center>
                                    </th>
                                    <th>
                                        <center>Nama_Camat</center>
                                    </th>
                                    <th>
                            ...
                            <tbody>
                                ...
                                while ($result = mysqli_fetch_assoc($sql)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center>
                                                <?php echo $result['luas_kecamatan']; ?>
                                            </center>
                                        </td>
                                        <td>
                                            <center>
                                                <?php echo $result['nama_camat']; ?>
                                            </center>
                                        </td>
                                        <td>
                                            <center>
                                        ...
                                        <td style="text-align: center">
                                            <a href="kelola.php?ubah=<?php echo $result['id_kecamatan']; ?>" type="button"
                                                class="btn btn-success btn-sm">
                                                <i class="fa fa-edit"></i>
                                                Ubah
                                            </a>
                                            <a href="proses.php?hapus=<?php echo $result['id_kecamatan']; ?>" type="button"

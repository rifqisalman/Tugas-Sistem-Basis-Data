...
$query = "SELECT * FROM projek_pembangunan";
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                ...
                <div class="container">
                    <h1 class="mt-4">
                        <center>Data Projek Pembangunan</center>
                    </h1>
                        ...
                        <table class="table align-middle table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>ID_Projek</th>
                                    <th>
                                        <center>Nama_Projek</center>
                                    </th>
                                    <th>
                                        <center>Jenis_Projek</center>
                                    </th>
                                    <th>Lokasi_Projek</th>
                                    <th>Status_Projek (%)</th>
                                    <th>Jumlah_Anggaran (Rp.)</th>
                                    <th>Tanggal_Mulai</th>
                                    <th>Tanggal_Selasai</th>
                                    <th>
                                        <center>Aksi</center>
                                    </th>
                                </tr>
                            ...
                            <tbody>
                                ...
                                while ($result = mysqli_fetch_assoc($sql)) {
                                    ...
                                    <tr>
                                        <td>
                                            <center>
                                                <?php echo $result['id_projek']; ?>
                                            </center>
                                        </td>
                                        <td>
                                            <?php echo $result['nama_projek']; ?>
                                        </td>
                                        <td>
                                            <?php echo $result['jenis_projek']; ?>
                                        </td>
                                        <td>
                                            <?php echo $result['lokasi_projek']; ?>
                                        </td>
                                        <td>
                                            <center>
                                                <?php echo $result['status_projek']; ?>
                                            </center>
                                        </td>
                                        <td>
                                            <center>
                                                <?php echo $result['jumlah_anggaran']; ?>
                                            </center>
                                        </td>
                                        <td>
                                            <center>
                                                <?php echo $result['tanggal_mulai']; ?>
                                            </center>
                                        </td>
                                        <td>
                                            <center>
                                                <?php echo $result['tanggal_selesai']; ?>
                                            </center>
                                        </td>
                                        <td>
                                            <a href="kelola.php?ubah=<?php echo $result['id_projek']; ?>" type="button"
                                                class="btn btn-success btn-sm">
                                                <i class="fa fa-edit"></i>
                                                Ubah
                                            </a>
                                            <a href="proses.php?hapus=<?php echo $result['id_projek']; ?>" type="button"

                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>
                                        <center>ID_PIC</center>
                                    </th>
                                    <th>
                                        <center>Nama_Perusahaan</center>
                                    </th>
                                    <th>
                                        <center>Nama_PIC</center>
                                    </th>
                                    <th>
                                        <center>Alamat_Perusahaan</center>
                                    </th>
                                    <th>
                                        <center>Peran</center>
                                    </th>
                            ...
                            <tbody>
                                ...
                                while ($result = mysqli_fetch_assoc($sql)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center>
                                                <?php echo $result['alamat_perusahaan']; ?>
                                            </center>
                                        </td>
                                        <td>
                                            <center>
                                                <?php echo $result['peran']; ?>
                                            </center>
                                        </td>
                                        <td>
                                            <a href="kelola.php?ubah=<?php echo $result['id_PIC']; ?>" type="button"
                                                class="btn btn-success btn-sm">
                                                <i class="fa fa-edit"></i>
                                                Ubah
                                            </a>
                                            <a href="proses.php?hapus=<?php echo $result['id_PIC']; ?>" type="button"
